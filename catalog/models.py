...
class Tag(models.Model):
    ...
    name = models.CharField(
        max_length=100, unique=True, help_text="Enter a new tag name"
    )
...
class Type(models.Model):
    ...
    name = models.CharField(
        max_length=100, unique=True, help_text="Enter a new lesson type"
    )
...
class Teacher(models.Model):
    ...
    name = models.CharField(
        max_length=200, unique=True, help_text="Enter a new teacher"
    )
...
class Student(models.Model):
    ...
    name = models.CharField(
        max_length=200, unique=True, help_text="Enter a new student"
    )
