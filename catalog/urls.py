...
urlpatterns = [
    ...
    path("inforequest/", views.info_request, name="info-request"),
    ...
    path(
        "student/<int:pk>/update/", views.StudentUpdate.as_view(), name="student-update"
    ),
    path(
        "student/<int:pk>/delete/", views.StudentDelete.as_view(), name="student-delete"
    ),
    path("teacher/create/", views.TeacherCreate.as_view(), name="teacher-create"),
    path(
        "teacher/<int:pk>/update/", views.TeacherUpdate.as_view(), name="teacher-update"
    ),
    path(
        "teacher/<int:pk>/delete/", views.TeacherDelete.as_view(), name="teacher-delete"
    ),
